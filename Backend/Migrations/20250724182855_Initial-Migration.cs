...
namespace Backend.Migrations
{
    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "StationServiceAvailabilities",
                columns: table => new
                {
                    ...
                    WellnessKitAvailable = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StationServiceAvailabilities", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CateringOrders_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                name: "WellnessKitRequests",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    KitType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WellnessKitRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WellnessKitRequests_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdultFare = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ChildFare = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PassengerDetails_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CateringOrders_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PassengerDetails_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WellnessKitRequests_ApplicationUserId",
                table: "WellnessKitRequests",
                column: "ApplicationUserId");
        }
